...
For instructions on creating an account and obtaining access to the Stage environment, see the [official InPost API portal](https://inpsa-api-portal.inpost-group.com/).
