...
Przykłady na stronach operacji są celowo krótkie i zakładają klienta utworzonego zgodnie z [instrukcją instalacji](../installation.md). Wartości przykładowe są syntetyczne. Operacje zmieniające stan uruchamiaj w Stage tylko po jawnym włączeniu zapisu.
