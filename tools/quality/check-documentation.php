...
const DOCUMENTATION_LOCALE_ENTRY_PAGES = [
    ...
    'pl/README.md',
    'pl/installation.md',
    'pl/client-and-environments.md',
    'pl/authentication.md',
    'pl/catalogue-and-offers.md',
    'pl/orders-and-post-sale.md',
    'pl/responses-and-errors.md',
    'pl/reliability.md',
    'pl/production-checklist.md',
    'pl/compatibility.md',
    'pl/api-reference.md',
];
